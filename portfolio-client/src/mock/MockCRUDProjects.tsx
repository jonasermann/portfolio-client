...
function MockCRUDAbout() {
  ...
  const [projects, setProjects] = useState(mockAppProps.projectProps.projects);

  const appProps: IAppProps = {
    homeProps: {} as IHomeProps,
    aboutProps: {} as IAboutProps,
    projectProps: { projects, setProjects },
  ...
  return (
    <MockContext.Provider value={appProps}>
      <CRUDProjects context={MockContext} token={'Unauthorized'} />
